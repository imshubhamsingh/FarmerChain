    ...
    componentDidMount(){
        ...
        $(document).ready(function() {
            ...
            (function ($) {
                ...
                let iframe = $('iframe');
                let iframeLoader = new TimelineLite({delay:0.5});

                iframeLoader.staggerFromTo(
                    iframe,
                    0.25,
                    { y: +20, autoAlpha:0},
        ...
        return(
            <div>
                {/*<div className="tab">*/}
                    ...
                    {/*</div>*/}
                {/*</div>*/}
                <iframe src="file:///home/shubham/Projects/reactjs/react-js-dashboard/blockchain/index.html"></iframe>
            </div>
        )
    }
